    ...
    .then((res) => {
      ...
      if (context?.$toolUtil.storageGet('frontSessionTable') == 'yisheng') {
        context?.$toolUtil.storageSet(
          'frontName',
          res.data.data.yishengzhanghao
        )
      }
      if (context?.$toolUtil.storageGet('frontSessionTable') == 'yisheng') {
        context?.$toolUtil.storageSet('headportrait', res.data.data.zhaopian)
      }
      if (context?.$toolUtil.storageGet('frontSessionTable') == 'huanzhe') {
        context?.$toolUtil.storageSet(
          'frontName',
          res.data.data.huanzhezhanghao
        )
      }
      if (context?.$toolUtil.storageGet('frontSessionTable') == 'huanzhe') {
...
.bottom_view {
  ...
  color: #fff;
  background: url() no-repeat center top / cover, #333;
  display: flex;
  width: 100%;
  font-size: 14px;
  min-height: 100px;
...
.menu_view {
  ...
  :deep(.is-active) {
    color: #fff !important;
    background: url(http://localhost:8080/hospitalRegistration/file/ef668850b0314d42bcd82eeda5c325c4.jpg)
      no-repeat center 56px !important;
