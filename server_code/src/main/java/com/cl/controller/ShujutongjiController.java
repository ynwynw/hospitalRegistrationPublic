...
import com.cl.service.ShujutongjiService;
...
public class ShujutongjiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShujutongjiEntity shujutongji,
		...
		if(tableName.equals("yisheng")) {
			shujutongji.setYishengzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		shujutongji = shujutongjiService.selectView(new EntityWrapper<ShujutongjiEntity>().eq("id", id));
    ...
    public R save(@RequestBody ShujutongjiEntity shujutongji, HttpServletRequest request){
    	shujutongji.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
